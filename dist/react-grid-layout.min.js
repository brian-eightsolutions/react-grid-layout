    ...
    function(t, e, n) {
      ...
      function l(t, e, n) {
        for (
          ...
          var p = i(s[l]);
          p.static || ((p = f(a, p, e, n, s, r, o)), a.push(p)),
            (u[t.indexOf(s[l])] = p),
            (p.moved = !1);
        }
        return u;
      ...
      function f(t, e, n, r, a, i, s) {
        var u = "vertical" === n,
          l = "horizontal" === n;
        if (u) for (e.y = Math.min(o(t), e.y); e.y > 0 && !h(t, e); ) e.y--;
        else if (l)
          for (!0 === s && (e.y = Math.min(o(t), e.y)); e.x > 0 && !h(t, e); )
            e.x--;
        for (var f = void 0; (f = h(t, e)); )
          l
            ? c(a, e, !0 === s ? f.x + f.w : f.x + f.w + i[0], "x")
            : c(a, e, !0 === s ? f.y + f.h : f.y + f.h + i[1], "y"),
            !0 === s && l && e.x + e.w > r && ((e.x = r - e.w), e.y++);
        return e;
      }
      function p(t, e, n, r) {
        for (var o = y(t), a = 0, i = t.length; a < i; a++) {
          var s = t[a];
          if (
            (!1 === r && s.x < 0 && (s.x = 0),
            !0 === r &&
              (s.x + s.w > e.cols && (s.x = e.cols - s.w),
              s.x < 0 && ((s.x = 0), (s.w = e.cols))),
            s.static)
          )
            for (; h(o, s); ) s.y++;
          else o.push(s);
        ...
        return (
          k.default.Children.forEach(e, function(e, n) {
            ...
            if (r) c[n] = i(r);
              ...
              a
                ? (M || O([a], "ReactGridLayout.children"),
                  (c[n] = i(T({}, a, { i: e.key }))))
                : (c[n] = i({ w: 1, h: 1, x: 0, y: o(c), i: String(e.key) }));
            }
          }),
          (c = p(c, { cols: n }, a, u)),
          (c = l(c, r, n, s, u))
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        function U(t, e, n, r, o, a) {
          ...
          if (!(n & bt)) {
            ...
            if (d || h) {
              var g = d ? t.value() : t,
                y = h ? e.value() : e;
              return a || (a = new P()), o(g, y, n, r, a);
            }
          }
          return !!p && (a || (a = new P()), K(t, e, n, r, o, a));
        }
        function Y(t) {
          return !(!pt(t) || rt(t)) && (ct(t) ? le : qt).test(it(t));
        }
        function X(t) {
        ...
        (Yt["[object Float32Array]"] = Yt["[object Float64Array]"] = Yt[
          ...
          (Yt[St] = Yt[_t] = Yt[Bt] = Yt[Rt] = Yt[It] = Yt[Ot] = Yt[Et] = Yt[
            jt
...
*/
    ...
    function(t, e, n) {
          ...
          return (
            ...
            (e.prototype.componentWillReceiveProps = function(t) {
              ...
              if (
                ...
                t.compactType === this.props.compactType
                  ? (0, y.childrenEqual)(this.props.children, t.children) ||
                    (e = this.state.layout)
                  : (e = t.layout),
                e)
              ) {
                var n = (0, y.synchronizeLayoutWithChildren)(
                    e,
                    t.children,
                    t.cols,
                    this.compactType(t),
            ...
            (e.prototype.containerHeight = function() {
              var t = this.state.layout,
                ...
                i = e.rowHeight;
              if (n) {
                if (!1 === a) return this.processFixedGridHeight();
                var s = (0, y.bottom)(t),
                  u = r ? r[1] : o[1];
                return s * i + (s - 1) * o[1] + 2 * u + "px";
              }
            }),
            (e.prototype.processFixedGridHeight = function() {
              var t = this.props.margin,
                e = this.state.layout;
              if (!e || !e.length) return "0px";
              var n = 0;
              return (
            ...
            (e.prototype.onDragStart = function(t, e, n, r) {
              var o = r.e,
                a = r.node,
                i = this.state.layout,
                s = (0, y.getLayoutItem)(i, t);
              s &&
                (this.setState({
                  oldDragItem: (0, y.cloneLayoutItem)(s),
            ...
            (e.prototype.onDrag = function(t, e, n, r) {
              var o = r.e,
                ...
                c = u.margin,
                f = u.onDrag,
                p = (u.preventCollision, u.responsive),
                d = (0, y.getLayoutItem)(s, t);
              if (d) {
                var h = {
                  w: d.w,
                  h: d.h,
                ...
                (s = (0, y.moveElement)(
                  ...
                  f(s, i, d, h, o, a),
                  this.setState({
                    layout: (0, y.compact)(s, this.compactType(), l, c, p),
                    activeDrag: h
                  });
              }
            }),
            (e.prototype.onDragStop = function(t, e, n, r) {
              ...
              if (d) {
                ...
                var h = (0, y.compact)(s, this.compactType(), l, c, p),
            ...
            (e.prototype.onResizeStart = function(t, e, n, r) {
              ...
              s &&
                (this.setState({
                  oldResizeItem: (0, y.cloneLayoutItem)(s),
                  oldLayout: this.state.layout
                }),
            ...
            (e.prototype.onResize = function(t, e, n, r) {
              var o = r.e,
                ...
                g = c.responsive,
                m = (0, y.getLayoutItem)(u, t);
              if (
                m &&
                (!h || !(0, y.getFirstCollision)(u, s({}, m, { w: e, h: n })))
              ) {
                (m.w = e), (m.h = n);
                var v = { w: e, h: n, x: m.x, y: m.y, static: !0, i: t };
                d(u, l, m, v, o, a),
                  this.setState({
                    layout: (0, y.compact)(u, this.compactType(), f, p, g),
                    activeDrag: v
                  });
              }
            }),
            (e.prototype.onResizeStop = function(t, e, n, r) {
              var o = r.e,
                ...
                p = l.onResizeStop,
                d = l.responsive;
              p(s, u, (0, y.getLayoutItem)(s, t), null, o, a);
              var h = (0, y.compact)(s, this.compactType(), c, f, d),
                g = this.state.oldLayout;
              this.setState({
                activeDrag: null,
                layout: h,
            ...
            (e.prototype.processGridItem = function(t) {
              if (t.key) {
                var e = this.state,
                  n = e.layout,
                  r = e.mounted,
                  o = (0, y.getLayoutItem)(n, String(t.key));
                if (!o) return null;
                var a = this.props,
                  i = a.width,
                  s = a.cols,
                  u = a.colWidth,
                  c = a.margin,
                  f = a.containerPadding,
                  p = a.rowHeight,
                  d = a.maxRows,
                  h = a.isDraggable,
                  g = a.isResizable,
                  m = a.useCSSTransforms,
                  b = a.draggableCancel,
                  x = a.draggableHandle,
                  S = a.responsive,
                  _ = Boolean(
                    !o.static && h && (o.isDraggable || null == o.isDraggable)
                  ),
                  D = Boolean(
                    !o.static && g && (o.isResizable || null == o.isResizable)
                  );
                return !1 === S
                  ? l.default.createElement(
                      v.default,
            ...
            (e.prototype.render = function() {
              var t = this,
                ...
                n = e.className,
                r = e.style,
                o = (0, g.default)("react-grid-layout", n),
      ...
      (x.displayName = "ReactGridLayout"),
        (x.propTypes = {
          ...
          layout: function(t) {
            var e = t.layout;
            void 0 !== e && (0, y.validateLayout)(e, "layout");
          },
    ...
    function(t, e, n) {
      ...
      function a(t, e, n, r, o, a, u, l) {
        if (t[n]) return (0, s.cloneLayout)(t[n]);
        for (
          var c = t[r],
            f = i(e),
            p = f.slice(f.indexOf(n)),
            d = 0,
            h = p.length;
          d < h;
          d++
        ...
        return (
          (c = (0, s.cloneLayout)(c || [])),
          (0, s.compact)(
            (0, s.correctBounds)(c, { cols: o }, 0, !0),
            a,
            o,
            u,
            l
    ...
    function(t, e, n) {
      ...
      (t.exports = n(6).default),
        (t.exports.utils = n(2)),
        (t.exports.Responsive = n(22).default),
        (t.exports.Responsive.utils = n(9)),
        (t.exports.WidthProvider = n(23).default);
    },
    function(t, e, n) {
      "use strict";
      var r = n(12),
    ...
    function(t, e, n) {
        ...
        y = (function(t) {
          function e() {
            ...
            return (
              ...
              (r.state = { dragging: null, className: "" }),
              (i = n),
              a(r, i)
            );
          }
          return (
            ...
            (e.prototype.calcPosition = function(t, e, n, r, o) {
              var a = { left: t, top: e, width: n, height: r };
              return (
                o &&
                  o.dragging &&
                  ((a.top = Math.round(o.dragging.top)),
                  (a.left = Math.round(o.dragging.left))),
                a.left > window.innerWidth - 41 &&
                  (a.left = window.innerWidth - 41),
                a
              );
            }),
            (e.prototype.calcXY = function(t, e) {
              var n = this.props,
                ...
                s = n.w,
                u = e > 0 ? e : 0;
              for (u + s > o && (u = o - s); u % (r + a[0]) != 0; ) u--;
              for (var l = t > 0 ? t : 0; l % (i + a[1]) != 0; ) l--;
              return { x: u, y: l };
            }),
            (e.prototype.createStyle = function(t) {
              ...
              return (
                o
                  ? (s = (0, d.setTransform)(t))
                  : ((s = (0, d.setTopLeft)(t)),
                    n &&
                      ((s.left = (0, d.perc)(t.left / r)),
                      (s.width = (0, d.perc)(t.width / r)))),
                (s.height = a),
                (s.width = i),
                s
              );
            ...
            (e.prototype.render = function() {
              var t = this.props,
                ...
                o = t.h,
                a = t.isDraggable,
                i = t.useCSSTransforms,
                u = this.calcPosition(e, n, r, o, this.state),
                c = l.default.Children.only(this.props.children),
                f = l.default.cloneElement(c, {
              ...
              return a && (f = this.mixinDraggable(f)), f;
            }),
            e
          );
        })(l.default.Component);
      (y.propTypes = {
        ...
        (y.defaultProps = { className: "", cancel: "", handle: "" }),
        (e.default = y);
    },
    function(t, e, n) {
      "use strict";
          ...
          return (
            ...
            (e.prototype.mixinResizable = function(t, e) {
              var n = this.props,
                ...
                h = [f.width, f.height],
                g = [Math.min(p.width, c), Math.min(p.height, 1 / 0)];
              return l.default.createElement(
                d.Resizable,
                {
                  width: e.width,
              ...
              return function(n, r) {
                ...
                if (i) {
                  ...
                  (y = Math.min(y, u - l)),
                    ...
                    i.call(e, c, y, m, { e: n, node: o, size: a });
                }
              };
            }),
            (e.prototype.render = function() {
    ...
    function(t, e, n) {
      ...
      (t.exports = function() {
        ...
        (t.exports.ResizableBox = n(21).default);
    },
    function(t, e, n) {
      "use strict";
      var r =
          ...
          return (
            ...
            (e.prototype.generateInitialState = function() {
              var t = this.props,
                ...
                o = t.margin,
                a = t.width,
                i = (0, y.getBreakpointFromWidth)(n, a),
                s = (0, y.getColsFromBreakpoint)(i, e),
                u =
                  !1 === this.props.verticalCompact
                    ? null
                    : this.props.compactType;
              return {
                layout: (0, y.findOrGenerateResponsiveLayout)(
                  r,
                  n,
                  i,
                  i,
            ...
            (e.prototype.onWidthChange = function(t) {
              var e = t.breakpoints,
                ...
                u =
                  t.breakpoint ||
                  (0, y.getBreakpointFromWidth)(t.breakpoints, s),
              ...
              if (
                ...
                l in o || (o[l] = (0, g.cloneLayout)(this.state.layout));
                var c = (0, y.getColsFromBreakpoint)(u, r),
                  f = (0, y.findOrGenerateResponsiveLayout)(
                    o,
                    e,
                    u,
                    l,
                ...
                (f = (0, g.synchronizeLayoutWithChildren)(
                  f,
                  n,
                  c,
                  a,
                  ...
                  (o[u] = f),
                  this.props.onLayoutChange(f, o),
                  this.props.onBreakpointChange(u, c),
                  ...
                  this.setState({ breakpoint: u, layout: f, cols: c });
              }
            }),
            (e.prototype.render = function() {
              var t = this.props,
